import { jsearchApi } from "../../app/services";
...
export const rideApi = jsearchApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    >({
      query: () =>
        "job-details?job_id=7oKm_SkxjLxpFtVuAAAAAA%3D%3D&extended_publisher_details=false",
    }),
  }),
});
...
export const { useGetJobDetailsQuery } = rideApi;
